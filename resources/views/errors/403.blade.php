...
<body class="relative min-h-screen bg-slate-950 text-slate-900" style="font-family: 'Plus Jakarta Sans', ui-sans-serif, system-ui, sans-serif;">
    ...
    <div class="pointer-events-none absolute -top-24 -right-20 h-72 w-72 rounded-full bg-rose-300/20 blur-3xl"></div>
    <div class="pointer-events-none absolute -bottom-32 -left-24 h-72 w-72 rounded-full bg-sky-500/20 blur-3xl"></div>
    ...
    <main class="relative z-10 mx-auto flex min-h-screen w-full max-w-3xl items-center px-4 py-6 sm:px-6 sm:py-10">
        <section class="w-full rounded-3xl border border-white/15 bg-white/95 p-5 text-center shadow-2xl sm:p-8">
            <p class="text-xs font-semibold uppercase tracking-[0.16em] text-rose-700">403 Forbidden</p>
            <h1 class="mt-2 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Akses Modul Ditolak</h1>
            ...
            <div class="mt-6 flex flex-col gap-2.5 sm:flex-row sm:justify-center">
                @auth
                    <a href="{{ route('ui.dashboard') }}" class="rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-700">
